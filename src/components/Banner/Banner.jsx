    ...
    return (
        <div className='mx-3 md:mx-0 flex flex-col justify-center items-center'>
            ...
            <div className=' flex gap-3 mb-10'>
                <a href="http://play.google.com"><button className="bg-[#D2D2D2] btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl"><img className='md:w-fit w-3' src={googlePlay} alt="" srcset="" />Google Play</button></a>
                <a href="http://www.apple.com/app-store/"><button className="bg-[#D2D2D2] btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl"><img className='md:w-fit w-3' src={appStore} alt="" srcset="" />App Store</button></a>
            </div>
            <img className='w-70 md:w-fit' src={heroImg} alt="" srcset="" />
        </div>
    );
};
